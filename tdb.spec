...
Source0  : https://www.samba.org/ftp/tdb/tdb-1.4.10.tar.gz
...
%prep
%setup -q -n tdb-1.4.10
cd %{_builddir}/tdb-1.4.10
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720549043
